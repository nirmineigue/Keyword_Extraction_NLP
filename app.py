...
def extract_topn_from_vector(features_names, sorted_items, topn=10):
    sorted_items = sorted_items[:topn]

    score_vals = []
    feature_vals = []
    for idx, score in sorted_items:
        fname = features_names[idx]
...
def extract_keywords():
    ...
    if document:
        ...
        keywords = extract_topn_from_vector(features_names, sorted_items, 20)
